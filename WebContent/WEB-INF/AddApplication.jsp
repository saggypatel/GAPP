...
<body>
	...
	<p><strong><a href="ApplicationList">CS Grad Admission</a> &gt; Add Application</strong></p>
	
	
	<form action="AddApplication" method="post">
	Applicant: <input type="text" name="name" /> <br />
	Application Recieved On(M/d/yyyy): <input type="text" name="date" /> <br />
	gpa: <input type="text" name="gpa" /> <br />
	Status:<select name="status">
			<option>Application Incomplete</option>
			<option selected="selected">Pending Review</option>
